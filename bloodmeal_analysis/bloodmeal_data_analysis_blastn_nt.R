...
mydata <- read.csv(file = 'bestHits_bloodmeal_batson_158_blastn_nt.out6', sep = '\t', header = FALSE)
...
##Get JPEG of plot
jpeg(paste0("Plot_of_bestHits_bloodmeal_batson_158_blastn_nt.out6.jpg"), width = 1920, height = 1080)

...
mydata <- read.csv(file = 'bloodmeal.contigs.blastx.nr.fmt6', sep = '\t', header = FALSE)
...
df2 <- subset(mydata, scomname %in% names(mycolumn[mycolumn > 3000]))
...
##Get JPEG of plot
jpeg(paste0("Plot_of_bloodmeal_batson_158_blastx_nr.fmt6.jpg"), width = 1920, height = 1080)
